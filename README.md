Memory-fs API for Scala.js
================================
This is a Scala.js type-safe binding for [memory-fs](https://www.npmjs.com/package/memory-fs)
...
```sbt
libraryDependencies += "io.scalajs.npm" %%% "memory-fs" % "0.4.1"
```
